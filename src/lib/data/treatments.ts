...
export const treatments: Treatment[] = [
  {
    ...
    equipment: ["amo-signature-whitestar", "zeiss-iolmaster-700", "alcon-centurion-phaco"],
    faqs: [
  ...
  },
  {
    ...
    shortDescription: "Specialized surgical care for the eyelids, tear ducts, orbit and surrounding structures.",
    icon: "shield",
    category: "Specialty",
    symptoms: ["Bulging eyes", "Drooping or swollen eyelids", "Watery eyes from blocked tear ducts", "Restricted eye movement"],
    diagnosis: ["Orbital Imaging", "Clinical Evaluation"],
    treatment: ["Eyelid reconstruction", "Orbital decompression", "Tear duct (DCR) surgery", "Tumor excision"],
  ...
  {
    slug: "macular-hole-surgery",
    name: "Macular Hole Surgery",
    shortDescription: "Precision micro-incision vitrectomy to close macular holes and restore central vision.",
    icon: "circle-dashed",
    featured: true,
    category: "Retina",
    symptoms: ["Blurred or distorted central vision", "A dark or empty patch at the centre of vision", "Difficulty reading or recognizing faces"],
    diagnosis: ["OCT Macular Scan", "Amsler Grid Testing", "Dilated Fundus Examination"],
    treatment: [
      "Micro-incision vitrectomy using the Alcon Constellation system",
      "Internal limiting membrane (ILM) peeling",
      "Gas tamponade to support hole closure",
    ],
    recovery: "Most patients maintain a brief face-down posture after surgery, with visual improvement over 4-8 weeks.",
    successRate: "94%",
    doctors: ["dr-p-mohan-krishna"],
    equipment: ["alcon-constellation-vitrectomy", "zeiss-lumera-microscope", "zeiss-cirrus-oct"],
    faqs: [
      { q: "Is macular hole surgery successful?", a: "Yes, with modern micro-incision vitrectomy techniques, macular hole closure rates are consistently high, with meaningful visual improvement in most patients." },
    ],
  },
  {
    slug: "scleral-fixation",
    name: "Scleral Fixation",
    shortDescription: "Secure intraocular lens fixation to the sclera for eyes without adequate capsular support.",
    icon: "anchor",
    featured: true,
    category: "Retina",
    symptoms: ["Dislocated or subluxated lens", "Absent capsular support after complicated cataract surgery", "Traumatic lens dislocation"],
    diagnosis: ["Slit Lamp Examination", "B-Scan Ultrasound", "Anterior Segment Evaluation"],
    treatment: [
      "Sutureless scleral-fixated IOL implantation",
      "Glued IOL / Yamane technique",
      "Combined vitrectomy for dislocated lens fragments",
    ],
    recovery: "Most patients recover functional vision within 2-4 weeks with routine post-operative monitoring.",
    successRate: "95%",
    doctors: ["dr-p-mohan-krishna"],
    equipment: ["alcon-constellation-vitrectomy", "zeiss-lumera-microscope"],
    faqs: [],
  },
  {
  ...
  },
  {
    ...
    shortDescription: "Corneal collagen cross-linking (C3R) to halt keratoconus progression and preserve vision.",
    icon: "scan-face",
    category: "Specialty",
    symptoms: ["Progressively blurred or distorted vision", "Increasing astigmatism", "Frequent changes in glasses power", "Glare and halos at night"],
    diagnosis: ["Corneal Topography (Sirius)", "Pachymetry", "Slit Lamp Examination"],
    treatment: [
      "Corneal Collagen Cross-Linking (C3R) to halt progression",
      "Custom rigid gas-permeable (RGP) or scleral contact lenses",
      "Intracorneal ring segments for select cases",
      "Corneal transplant referral for advanced disease",
    ],
    recovery: "C3R is an outpatient procedure. Most patients resume routine activity within a few days, with vision stabilizing over several months.",
    successRate: "95%",
    doctors: ["dr-b-prathyusha"],
    equipment: ["sirius-corneal-topography", "appasamy-c3r-crosslink"],
    faqs: [
      { q: "Can keratoconus be cured?", a: "Keratoconus cannot be reversed, but corneal collagen cross-linking effectively halts its progression when detected early." },
      { q: "Is cross-linking painful?", a: "The procedure is performed under topical anesthesia and is generally well tolerated, with mild discomfort for a day or two afterward." },
    ],
  },
  {
    slug: "pterygium-surgery",
    name: "Pterygium Surgery",
    shortDescription: "Surgical removal of pterygium growths with conjunctival autografting to prevent recurrence.",
    icon: "scissors",
    category: "Specialty",
    symptoms: ["Fleshy growth on the white of the eye", "Redness and irritation", "Foreign body sensation", "Blurred vision from astigmatism"],
    ...
    recovery: "Most patients experience mild redness for 1-2 weeks, with full comfort returning within a month.",
    successRate: "97%",
    doctors: ["dr-b-prathyusha"],
    equipment: ["sirius-corneal-topography"],
    faqs: [
      { q: "Does pterygium come back after surgery?", a: "With conjunctival autografting, recurrence rates are low, though regular follow-up is recommended." },
    ],
  },
  {
