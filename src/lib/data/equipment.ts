...
export const equipmentList: Equipment[] = [
  {
    ...
    purpose: "High-definition cross-sectional imaging of the retina for early detection of retinal and macular disease.",
  ...
  {
    slug: "centurion-silver-system",
    name: "Centurion Silver System",
    brand: "Alcon, USA",
    category: "Cataract Surgical",
    image: "/images/equipment/centurion.jpg",
    purpose: "Next-generation active fluidics cataract platform for consistent, gentle phacoemulsification.",
